# 100.times{ |i| User.create!( :email => "user#{i}@gmail.com", password: "11111111")}
#
# user0 = User.find(1), user0.friends = User.find_each(start: 10, finish: 19)

user200 = User.create(email: "user200@gmail.com", password: "11111111")
friend1 = User.create(friend_id: user1.id, email: "friend1@gmail.com", password: "11111111")
user200 = User.update(email: "user200@gmail.com", password: "11111111", friend_id: friend1.id)
...
friend1 = User.create(friend_id: user1.id, email: "friend1@gmail.com", password: "friend1@123")
